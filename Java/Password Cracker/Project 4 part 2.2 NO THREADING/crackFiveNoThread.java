 ...
 * folder without the use of threads
 * 
 * this program takes about 15 minutes to run
 */
import java.util.*;
import java.io.*;
...
public class crackFiveNoThread {
    public static void main(String[] args) {

        // variable declaration
        String zipPath = "protected5.zip";
        ArrayList<String> combinations = generateCombos("", 5);
